            ...
            <div className="overflow-x-auto relative">
                <table className="w-full text-sm text-gray-800">
                    <thead className="bg-[#FFF8F0] text-gray-700 text-sm uppercase">
                        <tr>
                            <th className="px-6 py-4 text-left sticky left-0 bg-[#FFF8F0] z-10">Vehicle Number</th>
                            ...
                            <th className="px-6 py-4 text-center sticky right-0 bg-[#FFF8F0] z-10">Status</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        {tableData.map((item, index) => (
                            <tr key={index} className="border-t hover:bg-gray-50 group">
                                ...
                                {/* VEHICLE */}
                                <td className="px-6 py-4 font-medium sticky left-0 bg-white group-hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4 text-center sticky right-0 bg-white group-hover:bg-gray-50">
                                    {
